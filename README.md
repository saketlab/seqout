<h1 align="left">
    <img src="./public/favicon.svg" height="32" align="absmiddle">
    Seqout
</h1>
...
Seqout also has an MCP server to help work with genomic datasets using AI agents (such as Claude, Codex, Antigravity etc.). Visit [seqout.org/map](https://seqout.org/map) for more information.
