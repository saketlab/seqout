...
const API: Category[] = [
    ...
    endpoints: [
      ...
      },
      {
        ...
        params: [
          ...
          { name: "multi_platform", type: "bool", description: "Only studies with 2+ sequencing platforms" },
  ...
  },
  {
    ...
    endpoints: [
      ...
      { method: "GET", path: "/run/{run}", summary: "Download links for a single run", description: "Get FASTQ/SRA download URLs, layout, file sizes, and MD5 checksums for one run accession. Returns 404 if the run is unknown.", params: [{ name: "run", type: "string", required: true, location: "path", description: "Run accession (SRR/ERR/DRR)" }], exampleParams: { run: "SRR6461096" }, responseHint: '{"run_accession": "SRR6461096", "study_accession": "SRP128859", "library_layout": "PAIRED", "fastq_ftp": "...", ...}' },
  ...
  },
  {
    ...
    endpoints: [
      ...
      { method: "GET", path: "/stats/platform-totals", summary: "Total experiments per platform", description: "Experiment counts per sequencing platform (ILLUMINA, OXFORD_NANOPORE, PACBIO_SMRT, etc.) with per-database breakdown and display names.", params: [], exampleParams: {} },
      { method: "GET", path: "/stats/platform-growth", summary: "Platform growth over time", description: "Monthly experiment or project counts for a sequencing platform. Supports instrument drill-down and cross-filters (organism, assay, country).", params: [{ name: "platform", type: "string", required: true, description: "Platform code (e.g. ILLUMINA, OXFORD_NANOPORE)" }, { name: "mode", type: "string", default: "experiments", description: "experiments or projects" }, { name: "instrument_model", type: "string", description: "Drill down to specific instrument" }, { name: "organism", type: "string", description: "Filter by organism" }, { name: "assay", type: "string", description: "Filter by assay (dominant_assay_l2)" }, { name: "country", type: "string", description: "Filter by country" }], exampleParams: { platform: "ILLUMINA", mode: "experiments" } },
      { method: "GET", path: "/stats/platform-instruments", summary: "Instruments for a platform", description: "List instrument models for a sequencing platform with experiment counts.", params: [{ name: "platform", type: "string", required: true, description: "Platform code" }], exampleParams: { platform: "OXFORD_NANOPORE" } },
      { method: "GET", path: "/stats/platform-filters", summary: "Filter options for a platform", description: "Available organisms, assays, and countries for a platform. Used for filter dropdown population.", params: [{ name: "platform", type: "string", required: true, description: "Platform code" }], exampleParams: { platform: "ILLUMINA" } },
    ],
  },
  {
