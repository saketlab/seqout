...
#'
#' @export
download_supplementary <- function(con, accession, dest_dir = NULL, quiet = FALSE) {
...
#'
#' @export
download_runs <- function(con, study, dest_dir = NULL,
...
#'
#' @export
download_script <- function(con, study, mode = "fastq", file = NULL) {
  .check_connection(con)
  rlang::check_required(study)
