...
export default function GeoProjectPage() {
  ...
  // Union of organisms across all GEO sample channels in this project,
  ...
  //
  // The backend populates two shapes for center data:
  //   1. Top-level `project.center_name` + `project.country_code` — the
  //      canonical single answer, same fields the search result card uses.
  //      Often populated even when `project.center[]` has null country_codes.
  //   2. Nested `project.center[]` — full address per affiliated institution.
  //      Drives the SubmittingOrgPanel at the bottom of the page.
  //
  // Prefer (1) because it's the consistent source across both APIs. Fall
  // back to walking (2) when the top-level fields are missing.
