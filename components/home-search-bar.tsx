...
// Two real, long-lived public deposits that are already canonical examples
// elsewhere in the app (FAQ, API docs, error messages). Clicking either one
// navigates straight to the project page — teaches both the accession format
// and the direct-navigation flow without forcing a search.
