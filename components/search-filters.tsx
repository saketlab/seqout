...
export function SearchFilters({
  ...
  // One compact toolbar at every viewport size: 3 select dropdowns
  // (sort / time / database) plus optional custom-year inputs.
  // Replaces the previous 14-radio-button desktop sidebar.
